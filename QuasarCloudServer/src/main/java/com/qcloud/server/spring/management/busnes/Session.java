...
public class Session {
    ...
    public void sessionAuthConfig(){
        Bot.sendMessage(new SendMessage(user.getTelegramId().toString(),"Теперь пришлите мне пожалуйста сообщение в виде: \"логин:пароль\" (без символов \") от ваших программ - что бы авторизоваться в системе. Не волнуйтесь я обрежу пустые символы и пробелы можете просто скопировать и вставить это сюда"));
        state = "auth";
    }
